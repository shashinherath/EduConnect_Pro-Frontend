...
export default function Ad_Lecturers({tableHead, tableData}) {
  return (
                    ...
                    <tr key={person.email}>
                      <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <div className="font-medium text-gray-900 text-left">{person.first_Name + " " + person.last_Name}</div>
                            <div className="text-gray-500 text-left">{person.email}</div>
                          </div>
                        </div>
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500 text-left">
                        <div className="text-gray-900">{person.password}</div>
